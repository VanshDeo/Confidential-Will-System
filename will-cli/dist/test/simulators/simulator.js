import { UndeployedConfig, currentDir, PreviewConfig, PreprodConfig } from '../../config';
...
export class TestEnvironment {
    ...
    static getProofServerContainer = async (env) => await new GenericContainer('midnightntwrk/proof-server:7.0.0')
