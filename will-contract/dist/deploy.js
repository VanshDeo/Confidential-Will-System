...
import { Contract } from './managed/will/contract/index.js';
...
const WillPrivateStateId = 'willPrivateState';
// ---------------------------------------------------------------------------
...
async function main() {
    ...
    // --- Compile contract ---
    const willCompiledContract = CompiledContract.make('will', Contract).pipe(CompiledContract.withVacantWitnesses, CompiledContract.withCompiledFileAssets(zkConfigPath));
    // --- Deploy ---
