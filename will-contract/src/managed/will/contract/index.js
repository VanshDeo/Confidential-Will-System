...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      init: (...args_1) => {
        ...
        const initialOwner_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('init',
                                     'argument 1 (as invoked from Typescript)',
                                     'will.compact line 17 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(initialOwner_0),
        ...
        const result_0 = this._init_0(context, partialProofData, initialOwner_0);
      ...
      addBeneficiary: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const person_0 = args_1[1];
        const amount_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addBeneficiary',
                                     'argument 1 (as invoked from Typescript)',
                                     'will.compact line 23 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(person_0.buffer instanceof ArrayBuffer && person_0.BYTES_PER_ELEMENT === 1 && person_0.length === 32)) {
          __compactRuntime.typeError('addBeneficiary',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'will.compact line 23 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(person_0).concat(_descriptor_2.toValue(amount_0)),
      ...
      executeWill: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`executeWill: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('executeWill',
                                     'argument 1 (as invoked from Typescript)',
                                     'will.compact line 35 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._executeWill_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      claim: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(person_0),
            alignment: _descriptor_1.alignment()
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this._claim_0(context, partialProofData, person_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      ...
      executeWill: this.circuits.executeWill,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('executeWill', new __compactRuntime.ContractOperation());
  ...
  _init_0(context, partialProofData, initialOwner_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(2n),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(initialOwner_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _addBeneficiary_0(context, partialProofData, person_0, amount_0) {
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_6.toValue(0n),
                                                                  alignment: _descriptor_6.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(person_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
  ...
  _executeWill_0(context, partialProofData) {
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
  ...
  _claim_0(context, partialProofData, person_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
